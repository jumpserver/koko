...
// 引入工具函数
import { updateIcon, handleError, formatMessage, sendEventToLuna } from '@/components/Terminal/helper';
...
export const useWebSocket = (terminalId: Ref<string>, options: paramsOptions): any => {
    ...
    const createWebSocket = (lastSendTime: Ref<Date>, fitAddon?: FitAddon, term?: Terminal, t?: any) => {
        _terminal = term;
        _fitAddon = fitAddon;
