...
func ConnectPasswordInputGuard(guard func() error) ConnectionOption {
	return func(opts *ConnectionOptions) {
		opts.passwordInputGuard = guard
	}
}
...
func (opts *ConnectionOptions) ConnectMsg() string {
	...
	case srvconn.ProtocolClickHouse,
		srvconn.ProtocolRedis, srvconn.ProtocolMongoDB, srvconn.ProtocolMariadb,
