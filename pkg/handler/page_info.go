...
func (p *pageInfo) updatePageInfo(pageSize, totalCount, offset int) {
	p.pageSize = pageSize
...
func (p *pageInfo) TotalCount() int    { return p.totalCount }
func (p *pageInfo) TotalPage() int     { return p.totalPage }
func (p *pageInfo) PageSize() int      { return p.pageSize }
func (p *pageInfo) CurrentPage() int   { return p.currentPage }
func (p *pageInfo) CurrentOffSet() int { return p.currentOffset }
